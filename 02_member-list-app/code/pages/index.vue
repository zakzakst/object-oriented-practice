<template>
  <div class="container">
    ...
    <!-- <member-edit-form
      v-if="memberItemForm"
      :name="memberItemForm.name"
      :tel="memberItemForm.tel"
      :mail="memberItemForm.mail"
      :messenger="memberItemForm.messenger"
      :teamId="memberItemForm.teamId"
    /> -->
    <!-- <member-edit-form
      name="山田太郎"
      tel="000-0000-0001"
...
import TeamCollection from '~/components/container/TeamCollection';
